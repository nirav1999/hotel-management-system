    ...
    <div class="container">
      <?php
                                  ...
                                  $result = $conn->query($sql);
                                      ...
                                      echo "<center class='text-info'><table class='table table1 table-striped'><thead><tr><th>customer id</th><th>feedback</th></tr></thead>";
                                      // output data of each row
                                      while($row = $result->fetch_assoc()) {
                                          echo "<tr><td>".$row["c_id"]."</td><td>".$row["feedback"]."</td></tr>";
                                      }
                                      echo "</table></center>";
